...
//! run: cargo run -p eqlp-app --release --example you_trio -- <log>
...
fn main() {
    let path = std::env::args().nth(1).expect("usage: you_trio <log>");
