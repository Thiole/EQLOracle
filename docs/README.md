...
- `windows-failure-modes.md` — every known Windows misbehavior (overlay,
  input, visibility, maps), status-tagged from the 2026-08-30 audit
- `api/` — the interface surface: command + pack catalogs (generated by
  `tools/gen_api_docs.py`), decoupling audit, plugin/endpoint roadmap
